...
const Booking = () => {
  ...
  const handleEditBooking = () => {
    router.push('/bookings/EditBooking');
  };

  return (
    <ScrollView className="p-4">
      <View className="mb-4 flex-row items-center justify-between rounded-lg bg-[#1f2937] p-4">
        ...
        <View className="flex-row">
          <IconButton
            ...
            className="bg-[#0078F0]"
            iconColor="#ffffff"
            disabled={booking.editAttempts !== 0}
          />
          <IconButton
            icon="delete"
            mode="contained"
      ...
      <Card className="mb-4 overflow-hidden rounded-lg bg-white p-4 shadow-sm">
        <Card.Content>
          {/* Location */}
          <View className="mb-4">
          ...
          <View className="flex flex-row items-center justify-between">
            ...
            <Text
              className={`text-base font-bold ${
                status === 'Ongoing' ? 'text-green-500' : 'text-red-500'
              }`}>
              {status}
            </Text>
          </View>
